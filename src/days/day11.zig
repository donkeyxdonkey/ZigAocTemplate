...
pub const Day11 = struct {
    pub fn part1(self: *Day11, input: *const []const u8, debug_print: bool) e.DayError![]const u8 {
        _ = &self;
        _ = &debug_print;
    ...
    pub fn part2(self: *Day11, input: *const []const u8, debug_print: bool) e.DayError![]const u8 {
        _ = &self;
        _ = &input;
        _ = &debug_print;

...
pub const Day19 = struct {
    pub fn part1(self: *Day19, input: *const []const u8, debug_print: bool) e.DayError![]const u8 {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    pub fn part2(self: *Day19, input: *const []const u8, debug_print: bool) e.DayError![]const u8 {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    pub fn create(self: *Day19) i.IDay {
        return .{
            .ptr = self,
            .vtable = &vtable,
        };

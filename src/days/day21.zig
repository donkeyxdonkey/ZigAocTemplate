...
pub const Day21 = struct {
    ...
    pub fn part1(self: *Day21, input: *const []const u8, debug_print: bool) !void {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    pub fn part2(self: *Day21, input: *const []const u8, debug_print: bool) !void {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    pub fn create(self: *Day21) interface.IDay {
        return .{
            .ptr = self,
            .vtable = &vtable,
        };

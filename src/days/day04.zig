...
pub const Day04 = struct {
    pub fn part1(self: *Day04, input: *const []const u8, debug_print: bool) !void {
        _ = &self;
        _ = &input;
    ...
    pub fn part2(self: *Day04, input: *const []const u8, debug_print: bool) !void {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    pub fn create(self: *Day04) interface.IDay {
        return .{
            .ptr = self,
            .vtable = &vtable,
        };

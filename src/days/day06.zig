...
pub const Day06 = struct {
    pub fn part1(self: *Day06, input: *const []const u8, debug_print: bool) !void {
        _ = &self;
        _ = &input;
    ...
    pub fn part2(self: *Day06, input: *const []const u8, debug_print: bool) !void {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    pub fn create(self: *Day06) interface.IDay {
        return .{
            .ptr = self,
            .vtable = &vtable,
        };

...
pub const Day07 = struct {
    ...
    pub fn part1(self: *Day07, input: *const []const u8, debug_print: bool) !void {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    pub fn part2(self: *Day07, input: *const []const u8, debug_print: bool) !void {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    pub fn create(self: *Day07) interface.IDay {
        return .{
            .ptr = self,
            .vtable = &vtable,
        };

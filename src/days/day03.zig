...
pub const Day03 = struct {
    pub fn part1(self: *Day03, input: *const []const u8, debug_print: bool) !void {
        _ = &self;
        _ = &input;
    ...
    pub fn part2(self: *Day03, input: *const []const u8, debug_print: bool) !void {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    pub fn create(self: *Day03) interface.IDay {
        return .{
            .ptr = self,
            .vtable = &vtable,
        };

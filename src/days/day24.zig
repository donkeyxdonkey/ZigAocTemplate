...
pub const Day24 = struct {
    pub fn part1(self: *Day24, input: *const []const u8, debug_print: bool) e.DayError![]const u8 {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    pub fn part2(self: *Day24, input: *const []const u8, debug_print: bool) e.DayError![]const u8 {
        _ = &self;
        _ = &input;
        _ = &debug_print;
    ...
    const vtable = i.IDay.VTable{
        ...
        .part2 = (struct {
            fn f(ptr: *anyopaque, input: *const []const u8, debug_print: bool) e.DayError![]const u8 {
                return @as(*Day24, @ptrCast(@alignCast(ptr))).part2(input, debug_print);
            }
        }).f,
    };
